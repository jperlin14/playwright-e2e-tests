...
// Original test.describe block that demonstrates use of annotation and tag
// test.describe(
//     'Login functionality',
//     { annotation: { type: 'User Story', description: 'This is the test description.' }, tag: '@regression' },
//     () => {

// Updated test.describe block w. @demo tag (removed annotation & tag example - original code above. Now tag is @demo.)
