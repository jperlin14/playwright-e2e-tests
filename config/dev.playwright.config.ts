...
// has loaded the Development environment configuration before executing any tests.
console.log('----- LOADING DEV ENVIRONMENT SETTINGS -----');
...
export default defineConfig<EnvConfig>({
    ...
    use: {
        ...
        // Note that executing using this dev environment config file will fail because we are using the Google URL
        // in place of the expected test app URL.
